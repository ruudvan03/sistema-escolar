        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    ...
                    <a href="#" class="group flex flex-col items-center p-4 rounded-xl border border-slate-100 bg-slate-50 hover:bg-indigo-50 hover:border-indigo-200 transition-all cursor-pointer">
                        ...
                        <span class="text-sm font-medium text-slate-600 group-hover:text-indigo-700 text-center">Alumnos</span>
                    </a>
